...
def validate(helpers, source_path, aliquot_source_path, emitter_directory):
    ...
    cna_of_file = os.path.join(emitter_directory, 'TCGA-ACC.HasCopyNumberAlteration.Edge.json.gz')
    ...
    helpers.assert_edge_file_valid(Aliquot, CopyNumberAlteration, cna_of_file)
