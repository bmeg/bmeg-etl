...
#   filename:  DrugResponse.yaml
#   timestamp: 2024-04-18T19:34:01+00:00
...
class DrugResponse(BaseModel):
    aac: Optional[float] = Field(None, description='Area above curve\n')
    auc: Optional[float] = Field(None, description='Area under curve\n')
    createdDateTime: Optional[AwareDatetime] = None
    doseUm: Optional[List] = Field(
        None,
        description='The drug doses (micromolar) for which responses were measured.\n',
    )
    dss1: Optional[float] = Field(
        None,
        description='Drug sensitivity score 1; an AUC measurement with the baseline noise subtracted.  https://www.ncbi.nlm.nih.gov/pubmed/24898935\n',
    )
    dss2: Optional[float] = Field(
        None,
        description='Drug sensitivity score 2; DSS1 further normalized by the logarithm of the top  asymptote Rmax. https://www.ncbi.nlm.nih.gov/pubmed/24898935\n',
    )
    dss3: Optional[float] = Field(
        None,
        description='Drug sensitivity score 3; DSS1 further normalized by the dose range over which  the response exceeds the activity threshold Amin. https://www.ncbi.nlm.nih.gov/pubmed/24898935\n',
    )
    ec50: Optional[float] = Field(
        None, description='The dose at which 50% of the maximum response is observed\n'
    )
    einf: Optional[float] = Field(
        None, description='The maximum theoretical inhibition\n'
    )
    hs: Optional[float] = Field(None, description='The Hill Slope\n')
    ic50: Optional[float] = Field(
        None, description='The dose that achieves  50% inhibition of cell viability\n'
    )
    id: Optional[str] = None
    projectId: str
    resourceType: Optional[str] = Field(
        'drug_response', description='One of the resource types defined as part of BMEG'
    )
    response: Optional[List] = Field(
        None, description='The measured drug response for a given drug dose.\n'
    )
    sourceCellName: Optional[str] = None
    sourceDrugName: Optional[str] = None
    submitterId: str
