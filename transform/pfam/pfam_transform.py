...
def emit_json(message):
    print json.dumps(MessageToDict(message))
...
def get_acc_list():
    out = []
    handle = urllib2.urlopen("http://pfam.xfam.org/families?output=text")
    for line in handle:
...
if __name__ == "__main__":
    ...
    parser_file.add_argument(
        "--output", "-o", default=sys.stdout, help="output file")
