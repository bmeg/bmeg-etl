...
class PDCTransformer():
    ...
    def __init__(self):
        # fetch data
        (self.all_cases, self.all_programs, self.all_studies) = pdc.load_all()
    ...
    def graph(self):
      ...
      edges = G.add_edges_from([(case.project_submitter_id, case.case_submitter_id) for case in self.all_cases],label='cases')
