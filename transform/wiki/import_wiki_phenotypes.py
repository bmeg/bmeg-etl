...
# see https://gen3.compbio.ohsu.edu/bmeg-wiki/index.php?title=Special:Ask&#options
"""
{{#ask: [[Category:Phenotype]]
 |?Term=term
 |?GID=gid
 |?Ontology.TermId=ontology_term_id
 |?PhenotypeSynonym.Term=synonym_term
 |?Ontology
 |format=broadtable
 |limit=500
 |offset=0
...
?PhenotypeSynonym.Term=synonym_terms
""".split())
...
@click.option('--output', default='outputs/wiki/PhenotypeSynonyms.json', help='output file path')
